...

{
    ...
    [SerializeField] public GameObject glowEffect; // this one idk if it works so just ignore it
    [SerializeField] public GameObject playArrow; //anything with this here is useless so don't mind it
